...
(function (shadow) {
    ...
    var DirectShadowDisplay3DShader = (function (_super) {
        ...
        DirectShadowDisplay3DShader.prototype.getFragmentShaderString = function () {
            var $str = "precision mediump float;\n" +
                ...
                "void main(void)\n" +
                "{\n" +
                "vec4 ft5 = texture2D(fs1, v_PositionFromLight.xy); " +
    ...
    var DirectShadowDisplay3DSprite = (function (_super) {
